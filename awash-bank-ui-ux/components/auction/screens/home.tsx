...
import { PhoneStatusBar, Badge } from "../ui"
import { CURRENCY, formatETB } from "@/lib/auctions"
  ...
  return (
    <div className="flex flex-1 flex-col lg:overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-5 pb-2 pt-1">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-bold">Selam Tesfaye</p>
            </div>
          </div>
          <button
      ...
      <div className="flex-1 px-5 pb-8 pt-5">
        {/* Featured Reverse Auction entry */}
        <button
          onClick={() => go("auctions")}
