...
import { PhoneStatusBar, CTAButton, Card } from "../ui"
...
export function WinnerScreen() {
  ...
  return (
    <div className="flex flex-1 flex-col lg:overflow-y-auto">
      ...
      <div className="flex flex-1 flex-col items-center bg-gradient-to-b from-[#141d47] to-card px-6 pb-28 pt-6 text-center lg:pb-8">
        ...
        <Card className="mt-6 w-full max-w-xs p-5">
          ...
          <div className="mt-1.5 flex justify-between text-xs">
            ...
            <span className="font-bold text-emerald-600">
              {CURRENCY} {formatETB(auction.marketPrice - (userBid ?? 0))}
            </span>
          </div>
        </Card>
      </div>
